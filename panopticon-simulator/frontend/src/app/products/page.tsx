...
export default function ProductsPage() {
    ...
    async function fetchData() {
      try {
        ...
        if (stored) {
          ...
          setAuthError(
            "Please sign in on the home page to add items to your cart."
          );
        }
      } catch (error) {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      ...
      return () =>
        window.removeEventListener("panopticon-user-change", handleUserChange);
    }
  }, []);
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                padding: "12px",
                background:
                  addingToCart === product.id || !currentUser
                    ? "#252525"
                    : "#1a1a1a",
                border: "1px solid #333",
                borderRadius: "6px",
